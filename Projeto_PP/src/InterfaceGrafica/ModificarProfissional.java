...
public class ModificarProfissional extends javax.swing.JFrame {

    public ModificarProfissional() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(577, 450));
        ...
        jPanel3.setBackground(new java.awt.Color(21, 167, 202));

        jLabel6.setFont(new java.awt.Font("Microsoft YaHei", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens_e_Icons/icons8_add_16px_1.png"))); // NOI18N
        ...
        jLabel1.setText("Novo Profissional");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens_e_Icons/LogoPPpeq_Easy-Resize.com (2).jpg"))); // NOI18N

        jPanel8.setBackground(new java.awt.Color(29, 134, 195));
        jPanel8.setPreferredSize(new java.awt.Dimension(61, 58));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens_e_Icons/icons8_exit_sign_24px.png"))); // NOI18N
